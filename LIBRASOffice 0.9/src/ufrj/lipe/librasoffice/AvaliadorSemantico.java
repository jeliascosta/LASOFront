...
public class AvaliadorSemantico {
	...
	public String avaliar (String str){
		...
		else if(texto.contains("desfazer") ||
		...
		else if(texto.contains("formas") &&
				texto.contains("simples")){
		...
		else if(texto.contains("inserir") &&
		...
		else if(texto.contains("tamanho") &&
				texto.contains("fonte")){
        	comando = "TAMANHO_DA_FONTE";
		}
    	else if(texto.contains("visualizar") &&
				texto.contains("impressão")){
