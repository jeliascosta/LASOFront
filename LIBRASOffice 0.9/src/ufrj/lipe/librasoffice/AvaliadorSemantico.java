...
public class AvaliadorSemantico {
	...
	public String avaliar(String str) {
		...
		if (comando_lwrc.contains("abrir")) {
		...
		} else if (comando_lwrc.contains("dinheiro")) {
			comandoLibras = "DINHEIRO_240";
		...
		} else if (comando_lwrc.contains("excluir") && comando_lwrc.contains("linhas")) {
			comandoLibras = "EXCLUIR_LINHAS";
		...
		} else if (comando_lwrc.contains("inserir") && comando_lwrc.contains("coluna") && comando_lwrc.contains("esquerda")) {
		...
		} else if(comando_lwrc.contains("funcoes") || comando_lwrc.contains("funç")){
			comandoLibras = "OPCAO_240";
		...
		} else if (comando_lwrc.contains("procurar")) {
			comandoLibras = "PROCURAR_240";
			...
			comandoLibras = "SOMA_240";
		} else if (comando_lwrc.contains("subtração")) {
			comando_lwrc = "SUB_240";
		...
		} else if (comando_lwrc.contains("texto")) {
			comandoLibras = "TEXTO_240";
