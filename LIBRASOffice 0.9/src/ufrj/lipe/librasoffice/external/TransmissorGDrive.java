...
public class TransmissorGDrive implements Runnable {
	...
	public HttpCredentialsAdapter authorize() throws IOException {
		System.out.println(TransmissorGDrive.class.getClassLoader().getResourceAsStream("LIBRASOffice-7b93cd6faf0e.p12"));
		try {
			PrivateKey privateKey = SecurityUtils.loadPrivateKeyFromKeyStore(SecurityUtils.getPkcs12KeyStore(),
					TransmissorGDrive.class.getClassLoader().getResourceAsStream("LIBRASOffice-7b93cd6faf0e.p12"), "notasecret", "privatekey","notasecret");
